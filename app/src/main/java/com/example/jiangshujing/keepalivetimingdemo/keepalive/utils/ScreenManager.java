package com.example.jiangshujing.keepalivetimingdemo.keepalive.utils;

import android.app.Activity;
import android.content.Context;
import android.content.Intent;
import android.util.Log;
import com.example.jiangshujing.keepalivetimingdemo.keepalive.SinglePixelActivity;
...
public class ScreenManager {
    ...
    // 启动SinglePixelActivity 一像素的 activtiy
    ...
    // 结束SinglePixelActivity 一像素的 activtiy
